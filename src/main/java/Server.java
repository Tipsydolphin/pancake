...
public class Server {
  ...
  public static void main(String[] args) {
    ...
    Stripe.apiKey = "sk_test_51NVkEeHAliF5JvgsC0QijOwMf3BU6xu8x1wbeIite2gjCWFlepqhiOxuC9klSTsa0a8hjA77HAJAblUQVBOSaAnV00576YOETg";
    // Replace this endpoint secret with your endpoint's unique secret
    // If you are testing with the CLI, find the secret by running 'stripe listen'
    // If you are using an endpoint defined with the API or dashboard, look in your
    // webhook settings
    // at https://dashboard.stripe.com/webhooks
    String endpointSecret = "ajkx-mbec-ttpe-bzcu-cheo";
    ...
    post("/webhook", (request, response) -> {
      ...
      try {
        ...
        // Invalid payload
        System.out.println("Warning:  Webhook error while parsing basic request.");
        response.status(400);
        return "";
      }
